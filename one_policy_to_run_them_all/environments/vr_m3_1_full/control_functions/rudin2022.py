class Rudin2022Control:
    def __init__(self, env, control_frequency_hz=50, p_gain=60, d_gain=2.0, scaling_factor=0.75):
        ...
        self.p_gains = self._values([150.0, 150.0, 120.0, 200.0, 200.0, 200.0] * 2 + [367.0] + [103.0, 94.0, 291.0, 291.0, 292.0, 218.0, 212.0] * 2)
        self.d_gains = self._values([25.0, 25.0, 4.0, 10.0, 8.0, 8.0] * 2 + [29.0] + [8.0, 7.0, 23.0, 23.0, 12.0, 9.0, 8.0] * 2)
        effort_limits = self._values([360.0, 360.0, 130.0, 360.0, 120.0, 120.0] * 2 + [102.0] + [66.0, 66.0, 34.0, 34.0, 11.0, 11.0, 11.0] * 2)
        self.scaling_factors = 0.0625 * effort_limits / self.p_gains
