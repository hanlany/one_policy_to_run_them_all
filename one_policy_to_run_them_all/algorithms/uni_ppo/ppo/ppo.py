...
class PPO:
    ...
    def load(config, env, run_path, writer, explicitly_set_algorithm_params):
        ...
        for key in (
            ...
            "bootstrap_weight_quantization_mode",
            "bootstrap_weight_quantization_target_bits",
            "bootstrap_weight_quantization_chunk_bits",
            "bootstrap_weight_quantization_sign_mode",
            "bootstrap_weight_quantization_scope",
    ...
    def test(self, episodes):
        ...
        pipeline = PolicyDistillationPipeline(
            ...
            bootstrap_config=BootstrapTrainingConfig(
                ...
                weight_quantization_mode=getattr(algorithm_config, "bootstrap_weight_quantization_mode", "legacy_8bit"),
                weight_quantization_target_bits=getattr(algorithm_config, "bootstrap_weight_quantization_target_bits", 24),
                weight_quantization_chunk_bits=getattr(algorithm_config, "bootstrap_weight_quantization_chunk_bits", 8),
                weight_quantization_sign_mode=getattr(algorithm_config, "bootstrap_weight_quantization_sign_mode", "mixed"),
                weight_quantization_scope=getattr(algorithm_config, "bootstrap_weight_quantization_scope", "all"),
