...
from one_policy_to_run_them_all.environments.vr_m3_1_12dof.viewer import MujocoViewer
from one_policy_to_run_them_all.environments.vr_m3_1_12dof.control_functions.handler import get_control_function
from one_policy_to_run_them_all.environments.vr_m3_1_12dof.command_functions.handler import get_command_function
from one_policy_to_run_them_all.environments.vr_m3_1_12dof.sampling_functions.handler import get_sampling_function
from one_policy_to_run_them_all.environments.vr_m3_1_12dof.initial_state_functions.handler import get_initial_state_function
from one_policy_to_run_them_all.environments.vr_m3_1_12dof.reward_functions.handler import get_reward_function
from one_policy_to_run_them_all.environments.vr_m3_1_12dof.termination_functions.handler import get_termination_function
from one_policy_to_run_them_all.environments.vr_m3_1_12dof.domain_randomization.action_delay_functions.handler import get_get_domain_randomization_action_delay_function
from one_policy_to_run_them_all.environments.vr_m3_1_12dof.domain_randomization.mujoco_model_functions.handler import get_domain_randomization_mujoco_model_function
from one_policy_to_run_them_all.environments.vr_m3_1_12dof.domain_randomization.seen_robot_functions.handler import get_domain_randomization_seen_robot_function
from one_policy_to_run_them_all.environments.vr_m3_1_12dof.domain_randomization.unseen_robot_functions.handler import get_domain_randomization_unseen_robot_function
from one_policy_to_run_them_all.environments.vr_m3_1_12dof.domain_randomization.perturbation_functions.handler import get_domain_randomization_perturbation_function
from one_policy_to_run_them_all.environments.vr_m3_1_12dof.observation_noise_functions.handler import get_observation_noise_function
from one_policy_to_run_them_all.environments.vr_m3_1_12dof.observation_dropout_functions.handler import get_observation_dropout_function
from one_policy_to_run_them_all.environments.vr_m3_1_12dof.terrain_functions.handler import get_terrain_function


class VRM31_12DOF(gym.Env):
    LONG_NAME = "vr_m3_1_12dof"
    SHORT_NAME = "vrm3_12"
    ...
    def __init__(self, seed, render,
        ...
        self.max_joint_velocities = np.array([
            14.653, 14.653, 31.4, 14.653, 16.747, 16.747,
            14.653, 14.653, 31.4, 14.653, 16.747, 16.747,
        ])
        self.initial_drop_height = 0.9
        ...
        self.model.dof_armature[6:] = np.array([0.1404, 0.1404, 0.02864, 0.1404, 0.03006, 0.03006] * 2)
        self.model.dof_frictionloss[6:] = np.array([0.1] * 12)
